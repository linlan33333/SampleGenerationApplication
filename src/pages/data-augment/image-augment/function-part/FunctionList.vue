...
import {PYFUNCTESTPATH, PYTESTIMAGEPATH} from "src/utils/global-args";
...
export default {
  ...
  setup() {
    ...
    return {
      ...
      imageRotate() {
        const params = [PYFUNCTESTPATH + 'imageRotate.py', '-input_folder', PYTESTIMAGEPATH + 'input1', '-angle', angle.value, '-output_folder', PYTESTIMAGEPATH + 'output'];
