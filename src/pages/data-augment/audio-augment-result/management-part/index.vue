<template>
  <div class="column full-width flex flex-center full-height">
    ...
    <q-scroll-area :thumb-style="thumbStyle" class="scroll-area-height full-width">
      <augment-result @showDisplayPart="showDisplayPart" />
    </q-scroll-area>
...
import AugResToolBar from "pages/data-augment/audio-augment-result/management-part/ToolBar.vue";
import AugmentResult from "pages/data-augment/audio-augment-result/management-part/Result.vue";
