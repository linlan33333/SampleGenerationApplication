...
<script>
import ToolBar from "pages/data-clean/text-clean/function-part/ToolBar.vue";
import FunctionList from "pages/data-clean/text-clean/function-part/FunctionList.vue";
import {ref} from "vue";
